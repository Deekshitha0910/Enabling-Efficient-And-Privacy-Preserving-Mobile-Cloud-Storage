		...
		<nav class="collapse navbar-collapse">
			<ul id="headernavigation" class="nav navbar-nav">
				<li><a href="cloud_page.jsp">Cloud Home</a></li>
			        ...
			        <li class="active"><a href="file_send.jsp">File send to TPA</a></li>	
...
<section id="page-top" class="section-style" data-background-image="images/background/page-top.jpg">
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/audit.jpg">
		<div class="pattern height-resize">
			<div class="container">
            ...
            %>
                                ...
                                <td><%=rs.getString("status")%></td>
                                 ...
                                 <td><a href="f_send.jsp?<%=rs.getString("file_name")%>,<%=mail%>" >Send to TPA</a> </td>
                               </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
                            ...
                            <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><bt><br><br><br><br><br><br><br><br><br><br><br><br>
