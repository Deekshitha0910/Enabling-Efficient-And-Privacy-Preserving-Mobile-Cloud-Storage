		...
		<nav class="collapse navbar-collapse">
			<ul id="headernavigation" class="nav navbar-nav">
				<li ><a href="admin_page.jsp">TPA Home</a></li>
                                 <li class="active"><a href="tkey_request.jsp">Time Stamp Upload secret key</a></li>	
...
<section id="page-top" class="section-style" data-background-image="images/background/page-top.jpg">
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/up1.jpg">
		<div class="pattern height-resize">
			<div class="container">
                            <br><br><br><br><br><br>
				<h3 class="section-name" >
					<span>
						Users Time Stamp Upload Key
					</span>
                                </h3>
                            <br>
                            <br>
        ...
        System.out.println( sdf.format(cal.getTime()) );
            ...
            %>
                                ...
                                <td><%=new TrippleDes().encrypt(rs.getString("ukey"))%></td>
