...
<body>
		...
		<nav class="collapse navbar-collapse">
			<ul id="headernavigation" class="nav navbar-nav">
				...
				<li class="active"><a href="cloud_downloads.jsp">Cloud Downloads</a></li>	
...
<section id="page-top" class="section-style" data-background-image="images/background/page-top.jpg">
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/cdown1.jpg">
		<div class="pattern height-resize">
			<div class="container">
