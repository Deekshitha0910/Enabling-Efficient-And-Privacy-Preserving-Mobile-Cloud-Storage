		...
		<nav class="collapse navbar-collapse">
			<ul id="headernavigation" class="nav navbar-nav">
				<li ><a href="index.html">Home</a></li>
                                <li class="active"><a href="user_login.jsp">Client</a></li>	
...
<section id="page-top" class="section-style" data-background-image="images/background/page-top.jpg">
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/client.jpg">
		<div class="pattern height-resize">
			<div class="container">
				...
				<form class="news-letter" method="get" action="client_login">
					<h3> E-Mail </h3>
					<div class="subscribe-hide">
						<input class="form-control" type="email"  name="name" placeholder="Email Address"  required>
				        </div>
                                        <h3> Password </h3>
					<div class="subscribe-hide">
						<input class="form-control" type="password"  name="pass" placeholder="Password"  required>
                                        ...
                                        <br>
				<center>   <input type="submit" value="Login"  style=" border-radius: 8px; height: 45px;width: 115px; color:white;background-color:black " class=""  />
