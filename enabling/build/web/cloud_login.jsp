...
<section id="page-top" class="section-style" data-background-image="images/background/page-top.jpg">
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/cloud_login1.jpg">
		<div class="pattern height-resize">
			<div class="container">
				...
				<form class="news-letter" method="get" action="cloud_login">
					<h3> Cloud ID </h3>
					<div class="subscribe-hide">
						<input class="form-control" type="text"  name="name" placeholder="Cloud ID"  required>
				        </div>
                                        <h3> Password </h3>
					<div class="subscribe-hide">
